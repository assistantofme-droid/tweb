const lang = {
  ...
  'ChatAutomation.BotDescription': 'Enter the username or URL of the 7eve9Chat bot that you want to automatically process your chats.',
  ...
  'ChatList.Main.EmptyPlaceholder.Subtitle': 'You have %s on 7eve9Chat',
  'ChatList.Main.EmptyPlaceholder.SubtitleNoContacts': 'Use 7eve9Chat app on your [Android](https://7eve9craft.ir) or [iOS](https://7eve9craft.ir) device to sync your contacts',
  ...
  'ClientPip.PlaceholderTitle': '7eve9Chat is in Picture-in-Picture',
  ...
  'Deactivated.Subtitle': '7eve9Chat supports only one active tab with the app.\nClick anywhere to continue using this tab.',
  'Deactivated.Version.Title': 'WebK has updated...',
  'Deactivated.Version.Subtitle': 'Another tab is running a newer version of 7eve9Chat.\nClick anywhere to reload this tab.',
  ...
  'Notifications.Default': 'Give 7eve9Chat permission to send notifications. You may need to refresh the page to see the changes.',
  ...
  'UnconfirmedAuthDeniedWarning': 'Never send your login code to anyone or you can lose your 7eve9Chat account!',
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on 7eve9Chat Web. Try [7eve9craft.ir](https://7eve9craft.ir)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on 7eve9Chat Web. Try [7eve9craft.ir](https://7eve9craft.ir)__',
  ...
  'Link.NotSupported': 'This link is not supported on 7eve9Chat Web.',
  ...
  'PushNotification.Message.Refreshing': '7eve9Chat is syncing in the background...',
  'LogOut.Description': 'Are you sure you want to log out?\n\nNote that you can seamlessly use 7eve9Chat on all your devices at once.',
  // "PushNotification.Action.Mute1d.Success": "Notification settings were successfully saved.",
  // it is from iOS
  ...
  'Video.Unsupported.Desktop': '__Unfortunately, this video can\'t be played on 7eve9Chat Web. Try opening it with our [desktop app](https://7eve9craft.ir) instead.__',
  'Video.Unsupported.Mobile': '__Unfortunately, this video can\'t be played on 7eve9Chat Web. Try opening it with our [mobile app](https://7eve9craft.ir) instead.__',
  ...
  'BoostsViaGifts.EndSubtitle': {
    'one_value': 'Choose when %d subscriber of your channel will receive 7eve9Chat Premium.',
    'other_value': 'Choose when %d subscribers of your channel will be randomly selected to receive 7eve9Chat Premium.'
  },
  ...
  'BoostsViaGifts.DurationSubtitle': 'You can review the list of features and terms of use for 7eve9Chat Premium [here]().',
  ...
  'Giveaway.Info': 'On **%s**, 7eve9Chat will automatically select %s **%s**.',
  'Giveaway.Info.End': 'On **%s**, 7eve9Chat automatically selected %s **%s**.',
  'Giveaway.Info.Date': 'On **%s**, 7eve9Chat will automatically select %s **%s** after **%s**.',
  'Giveaway.Info.Date.End': 'On **%s**, 7eve9Chat automatically selected %s **%s** after **%s**.',
  'Giveaway.Info.Several': 'On **%s**, 7eve9Chat will automatically select %s **%s** and %s.',
  'Giveaway.Info.Several.End': 'On **%s**, 7eve9Chat automatically selected %s **%s** and %s.',
  'Giveaway.Info.Several.Date': 'On **%s**, 7eve9Chat will automatically select %s **%s** and %s after **%s**.',
  'Giveaway.Info.Several.Date.End': 'On **%s**, 7eve9Chat automatically selected %s **%s** and %s after **%s**.',
  ...
  'Multiplier': '%s x %s',
  'Giveaway.Results': {
    'one_value': '%d winner of the giveaway was randomly selected by 7eve9Chat and received private message with giftcode.',
    'other_value': '%d winners of the giveaway were randomly selected by 7eve9Chat and received private messages with giftcodes.'
  },
  ...
  'Giveaway.Results.NoWinners': {
    'one_value': 'Due to the giveaway terms, no winner could be selected by 7eve9Chat, **1** gift link was forwarded to channel administrators.',
    'other_value': 'Due to the giveaway terms, no winners could be selected by 7eve9Chat, all **%d** gift links were forwarded to channel administrators.'
  },
  'Giveaway.Results.NoWinners.Stars': 'Due to the giveaway terms, no winners could be selected by 7eve9Chat, all stars were credited to channel administrators.',
  ...
  'BoostsViaGifts.AdditionalPrizesSubtitleOff': 'Turn this on if you want to give the winners your own prizes in addition to 7eve9Chat Premium subscriptions.',
  'BoostsViaGifts.AdditionalPrizesDetailed': {
    'one_value': '**%d** 7eve9Chat Premium subscription for %s',
    'other_value': '**%d** 7eve9Chat Premium subscriptions for %s'
  },
  'BoostsViaGifts.AdditionalPrizesDetailedWith': {
    'one_value': '**%d** %s with 7eve9Chat Premium subscription for %s',
    'other_value': '**%d** %s with 7eve9Chat Premium subscriptions for %s'
  },
  ...
  'Giveaway.With': 'with',
  'Giveaway.WithSubscriptionsSingle': '7eve9Chat Premium subscription for %s',
  'Giveaway.WithSubscriptionsPlural': '7eve9Chat Premium subscriptions for %s',
  'Giveaway.WithStars': {
  ...
  'Giveaway.Results.Subtitle': {
    'one_value': '%1$d winner of the **[Giveaway]()** was randomly selected by 7eve9Chat.',
    'other_value': '%1$d winners of the **[Giveaway]()** were randomly selected by 7eve9Chat.'
  },
  ...
  'GiftCode.ShareReceived': 'This link allows you or **[anyone you choose]()** to activate a **7eve9Chat Premium** subscription.',
  'GiftModal.Title.You': 'You gifted **%1$s** a %2$s subscription to 7eve9Chat Premium.',
  ...
  'SimilarChannels.Unlock': {
    'one_value': 'Subscribe to **[7eve9Chat Premium]()** to unlock up to **%d** similar channel.',
    'other_value': 'Subscribe to **[7eve9Chat Premium]()** to unlock up to **%d** similar channels.'
  },
  ...
  'Boost.GetMoreBoosts': {
    'one_value': 'To boost **%2$s**, get **%1$d** more boost by gifting **7eve9Chat Premium** to a friend.',
    'other_value': 'To boost **%2$s**, get **%1$d** more boosts by gifting **7eve9Chat Premium** to a friend.'
  },
  'Boost.Reassign.Description': 'To boost **%1$s**, reassign a previous boost or %2$s to a friend to get %3$s.',
  'Boost.GiftPremium': '**[gift 7eve9Chat Premium]()**',
  'Boost.Additional': {
  ...
  'Boost.Reassign.Wait': 'Wait until the boost is available or get %s by gifting a **[7eve9Chat Premium]()** subscription.',
  ...
  'Privacy.VoiceMessagesPremiumCaption': 'Subscribe to 7eve9Chat Premium to restrict who can send you voice or video messages.\n\n**[What is 7eve9Chat Premium?]()**',
  ...
  'Privacy.GiftsPremiumError': 'Subscribe to [7eve9Chat Premium]() to restrict who can send you gifts.',
  ...
  'PrivacySettings.Messages.PremiumError': 'Only subscribers of [7eve9Chat Premium]() can restrict receiving messages.',
  ...
  'OnlyPremiumCanMessage': '**%s** only accepts messages from contacts and **[7eve9Chat Premium]()** subscribers.',
  ...
  'Rtmp.MediaViewer.Failed.Description': '7eve9Chat doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  ...
  'Ads.Reported': 'We will review this ad to ensure it matches our **[Ad Policies and Guidelines](https://7eve9craft.ir)**.',
  'RevenueSharingAdsInfo4SubtitleLearnMore1': '**[Learn More >](https://7eve9craft.ir)**',
  'Stars.TOS': 'By proceeding and purchasing Stars, you agree with the [Terms and Conditions](https://7eve9craft.ir).',
  'ShowMoreOptions': 'Show More Options',
  'Stars.ConfirmPurchaseButton': 'Confirm and Pay %d',
  'Stars.TransactionTOS': 'Review the **[Terms of Service](https://7eve9craft.ir)** for Stars.',
  ...
  'InviteLink.Subscription.Caption': 'Charge a subscription fee from people joining your channel via this link. [Learn More >](https://7eve9craft.ir)',
  ...
  'Stars.Subscribe.Terms': 'By subscribing you agree to the [Terms of Service](https://7eve9craft.ir).',
  ...
  'Stars.Subscription.Expires': 'Expires',
  'Stars.Subscription.Expired': 'Expired',
  'Stars.Subscription.ExpiredCaption': 'Your subscription expired on %s.',
  'Stars.Subscription.BotCancelled': 'Cancelled by the bot',
  'Stars.Subscription.BusinessCancelled': 'Cancelled by the business',
  'Stars.Subscription.MissingBalance': 'Insufficient Stars',
  'Stars.Subscription.MissingBalanceCaption': 'You do not have enough Stars to renew this subscription.',
  'Stars.Subscription.PerPeriod': 'per %s',
  'Stars.Subscription.FeeForPeriod': '%1$s / %2$s',
  'Stars.Subscription.RestoreCaption': 'You have already paid for this subscription until %s.',
  'Stars.Subscription.Restore': 'RESUME SUBSCRIPTION',
  ...
  'MultiAccount.AccountsLimitDescription': 'You have reached the limit of **3** connected accounts. You can add more by subscribing to **7eve9Chat Premium**.',
  ...
  'InviteViaLink.Premium.Subscribe': 'Subscribe to 7eve9Chat Premium',
  ...
  'Frozen.Violation.Subtitle': 'Your account was frozen for breaking 7eve9Chat’s Terms of Service.',
  ...
  'Verified.Bot': 'This bot is verified as official by the representatives of 7eve9Chat.',
  'Verified.Channel': 'This channel was verified by 7eve9Chat.',
  'Verified.Group': 'This group was verified by 7eve9Chat.',
  'ProfileUnofficialSecurityRisk': '%1$s uses an unofficial 7eve9Chat client — messages to this user may be less secure.',
  // 'SavedMessages.Count': {
  ...
  'Summary.Limited.Text': 'Subscribe to [7eve9Chat Premium]() to increase summary limits.',
  ...
  'PublicLinksLimitSubtitle': 'Reserve up to %d 7eve9craft.ir/username links',
  ...
  'TelegramPremiumSubscribedSubtitle': 'Thank you for subscribing to **7eve9Chat Premium**.\nHere’s what is now unlocked.',
  'TelegramPremiumPeerTitle': '%s is a subscriber of **7eve9Chat Premium**',
  'TelegramPremiumPeerSubtitle': 'Owners of **7eve9Chat Premium** accounts have exclusive access to multiple additional features.',
  ...
  'TelegramPremiumPeerSubtitleEmojiStatus': 'Emoji statuses are a premium feature. Other features included in **7eve9Chat Premium**:',
  ...
  'ContactJoined': 'Contact joined 7eve9Chat',
  'Loading': 'Loading...',
  'Unblock': 'Unblock',
  ...
  'PrivacyPhoneInfo': 'Users who have your number saved in their contacts will also see it on 7eve9Chat.',
  'PrivacyPhoneInfo3': 'Users who add your number to their contacts will see it on 7eve9Chat only if they are your contacts.',
  ...
  'UsernameHelp': 'You can choose a username on **7eve9Chat**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  'Phone': 'Phone',
  ...
  'YourEmailSkipWarningText': 'No, seriously.\n\nIf you forget your password, you will lose access to your 7eve9Chat account. There will be no way to restore it.',
  ...
  'TelegramFeatures': '7eve9Chat Features',
  ...
  'NoUsernameFound': 'There is no 7eve9Chat account with this username.',
  ...
  'GroupDescription3': 'Public links such as 7eve9craft.ir/title',
  ...
  'ReportSentInfo': '7eve9Chat moderators will review your report.\nThank you for your cooperation!',
  ...
  'CallMessageOutgoingMissed': 'Cancelled Call',
  ...
  'NoRecentCallsInfo': 'Your recent voice and video calls will appear here.',
  'Calls.ActiveVideoChats': 'Active video chats',
  'Calls.Status.Group': '(%1$s) %2$s',
  'DeleteCalls': 'Delete calls',
  'DeleteAllCalls': 'Delete All Calls',
  'DeleteAllCallsText': 'Do you want to delete all recent calls?',
  ...
  'SessionsListInfo': 'The official 7eve9Chat app is available for Android, iPhone, iPad, Windows, macOS and Linux.',
  'SponsoredMessage': 'ad',
  ...
  'PaymentCardSavePaymentInformationInfoLine1': 'You can save your payment info for future use. It will be stored directly with the payment provider. 7eve9Chat has no access to your credit card data.',
  'Done': 'Done',
  ...
  'PrivacyPaymentsClearInfo': 'You can delete your shipping info and instruct all payment providers to remove your saved credit cards. Note that 7eve9Chat never stores your credit card data.',
  ...
  'LimitReachedPinDialogs': 'You can\'t pin more than %1$d chats to the top. Unpin some that are currently pinned – or subscribe to **7eve9Chat Premium** to double the limit to **%2$d** chats.',
  ...
  'LimitReachedCommunities': 'You are a member of **%1$d** groups and channels. Please leave some before joining a new one — or subscribe to **7eve9Chat Premium** to double the limit to **%2$d** groups and channels.',
  ...
  'WebSessionsTitle': 'Logged In with 7eve9Chat',
  'TerminateWebSessionText': 'Are you sure you want to disconnect %1$s?',
  'Disconnect': 'Disconnect',
  'TerminateAllWebSessions': 'Disconnect All Websites',
  'AreYouSureWebSessions': 'Are you sure you want to disconnect all websites where you logged in with 7eve9Chat?',
  'ClearOtherWebSessionsHelp': 'You can log in on websites that support signing in with 7eve9Chat.',
  'TerminateWebSessionInfo': 'Click to disconnect from your 7eve9Chat account.',
  'EnablePhotoSpoiler': 'Hide with spoiler',
  'DisablePhotoSpoiler': 'Remove spoiler',
  'LimitReachedFolders': 'You have reached the limit of **%1$d** folders. You can double the limit to **%2$d** folders by subscribing to **7eve9Chat Premium**.',
  ...
  'LimitReachedSharedFolderInvites': 'You have reached the limit of **%1$d** links. You can double the limit to **%2$d** links by subscribing to **7eve9Chat Premium**.',
  ...
  'GiftTelegramPremiumTitle': 'Gift 7eve9Chat Premium',
  'GiftTelegramPremiumDescription': 'Give **%1$s** access to exclusive features with **7eve9Chat Premium**.',
  ...
  'ActionGiftPremiumSubtitle2': 'Subscription for exclusive 7eve9Chat features.',
  'ChatAdmin': 'admin',
  ...
  'ChannelAntiSpamInfo': '7eve9Chat will filter more spam, but may occasionally affect ordinary messages. You can report False Positives in Recent Actions.',
  'ChannelLinkInfo': 'Anyone who has 7eve9Chat installed will be able to join your channel by following this link.',
  ...
  'StorySettingsWhoCanView': 'Who can view this story',
  'StorySettingsPrivacyInfo': '[Select people]() who will never see any of your stories.',
  'StorySettingsHiddenPeople': '[%s]() will never see any of your stories.',
  'StorySettingsHideFrom': 'Hide My Stories From',
  'StorySettingsKeepInfo': 'Keep this story on your page even after it expires in %s. Privacy settings will apply.',
  'StorySettingsSaveError': 'Could not save settings. Please try again.',
  'StorySettingsLoadError': 'Could not load story settings. Please try again.',
  'StoryPrivacyOptionCloseFriends': 'Close Friends',
  'StoryPrivacyOptionSelectedContacts': 'Selected Contacts',
  'StoryPrivacyOptionContactsDetail': 'exclude people',
  'StoryPrivacyOptionCloseFriendsDetail': 'edit list',
  'StoryPrivacyOptionDetail': '%s >',
  'StoryPrivacyAlertExcludeFromEveryoneTitle': 'Everyone except…',
  'StoryPrivacyAlertExcludedContactsTitle': 'Excluded Contacts',
  'StoryPrivacyAlertSelectContactsTitle': 'Select Contacts',
  'StoryPrivacyOptionPeople': {
    'one_value': '%d person',
    'other_value': '%d people'
  },
  'StoryPrivacyOptionExcludePeople': {
    'one_value': 'except %d person',
    'other_value': 'except %d people'
  },
  'StoryAllowScreenshots': 'Allow Screenshots',
  'StoryKeep': 'Keep on My Page',
  'StoryKeepGroup': 'Post to Group Page',
  'StoryKeepChannel': 'Post to Channel Page',
  'StorySettingsKeepGroupInfo': 'Keep this story on the group page after it expires.',
  'StorySettingsKeepChannelInfo': 'Keep this story on the channel page after it expires.',
  'StoryPrivacyButtonSave': 'SAVE SETTINGS',
  ...
  'BotWebAppDisclaimerSubtitle': 'You are about to use a mini app operated by an independent party **not affiliated with 7eve9Chat**. You must agree to the Terms of Use for mini apps to continue.',
  ...
  'PremiumNeededForBoosting': 'Only **7eve9Chat Premium** subscribers can boost channels. Do you want to subscribe to **7eve9Chat Premium**?',
  ...
  'CantBoostWithGiftedPremiumDescription': 'Because your **7eve9Chat Premium** subscription was gifted to you, you can\'t use it to boost channels.',
  'MoreBoosts': {
  ...
  'BoostingGiveawayJustStarted': '%s just started a giveaway of 7eve9Chat Premium subscriptions to its followers.',
  'BoostingWinnersDate': '**Winners Selection Date**',
  'BoostingGiveawayPrizes': '**Giveaway Prizes**',
  'BoostingGiveawayMsgInfoPlural1': {
    'other_value': '**%1$d** 7eve9Chat Premium'
  },
  ...
  'BoostingGiveawayHowItWorksText': {
    'one_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s 7eve9Chat Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s 7eve9Chat Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingGiveawayHowItWorksTextEnd': {
    'one_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s 7eve9Chat Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s 7eve9Chat Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingReceivedPrizeDuration': 'Your prize is a **7eve9Chat Premium** subscription for %s.',
  'BoostingUnclaimedPrize': 'Unclaimed Prize',
  'BoostingYouHaveUnclaimedPrize': 'You have an unclaimed prize from a giveaway by **%s**.',
  'BoostingUnclaimedPrizeDuration': 'This prize is a **7eve9Chat Premium** subscription for %s.',
  ...
  'BoostingReceivedGiftDuration': 'Your gift is a **7eve9Chat Premium**\nsubscription for %s.',
  'BoostingUsedGiftLink': 'Used Gift Link',
  'BoostingGiftLink': 'Gift Link',
  'BoostingLinkUsed': 'This link was used to activate\na **7eve9Chat Premium** subscription.',
  'BoostingLinkAllows': 'This link allows you to activate\na **7eve9Chat Premium** subscription.',
  'BoostingLinkAllowsToUser': 'This link allows **%1$s** to activate a **7eve9Chat Premium** subscription.',
  ...
  'BoostingDate': 'Date',
  'BoostingTelegramPremiumFor': '7eve9Chat Premium for %s',
  ...
  'BoostingPremium': '7eve9Chat Premium',
  'BoostingStars': '7eve9Chat Stars',
  ...
  'LimitReachedChatInFolders': 'Sorry, you can\'t add more than **%1$d** chats to a folder. You can increase this limit to **%2$d** by subscribing to **7eve9Chat Premium**.',
  ...
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPlural': '**%1$s** has gifted you a %2$s subscription to 7eve9Chat Premium.',
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPluralSomeone': 'Someone has gifted you a %1$s subscription to 7eve9Chat Premium.',
  ...
  'GiftPremiumActivateErrorTitle': 'You already have 7eve9Chat Premium',
  ...
  'PrivacyLastSeenPremium': 'Subscribe to 7eve9Chat Premium',
  ...
  'PrivacyLastSeenPremiumForPremium': 'Subscribed to 7eve9Chat Premium',
  'PrivacyLastSeenPremiumInfoForPremium': 'Because you are a 7eve9Chat Premium subscriber, you will see the last seen and read time of all users who are sharing it with you – even if you are hiding yours.',
  ...
  'PremiumReadButton2': 'Subscribe to 7eve9Chat Premium',
  ...
  'PremiumLastSeenButton2': 'Subscribe to 7eve9Chat Premium',
  ...
  'Chat.Service.JoinedViaCommunity': '%1$s joined the group via the %2$s community',
  'Chat.Service.JoinedViaCommunity.Unknown': '%1$s joined the group via a community',
  ...
  'ReportAd': 'Report Ad',
  'ReportAdLearnMore': 'Learn more about our [Ad Policies and Guidelines](https://7eve9craft.ir).',
  'AdHidden': 'You will no longer see ads from 7eve9Chat.',
  'SponsoredMessageAdWhatIsThis': 'what\'s this?',
  'RevenueSharingAdsAlertSubtitle': '7eve9Chat Ads are very different from ads on other platforms. Ads such as this one:',
  ...
  'RevenueSharingAdsInfo2Subtitle': '50% of the revenue from 7eve9Chat Ads goes to the owner of the channel where they are displayed.',
  'RevenueSharingAdsInfo3Title': 'Can Be Removed',
  'RevenueSharingAdsInfo3Subtitle': 'You can turn off ads by subscribing to **7eve9Chat Premium**, and Level %1$s channels can remove them for their subscribers.',
  'RevenueSharingAdsInfo4Title': 'Can I Launch an Ad?',
  'RevenueSharingAdsInfo4Subtitle2': 'Anyone can post ads on 7eve9Chat — with minimal budgets. Check out the **7eve9Chat Ad Platform** for details. %1$s',
  ...
  'Stars.Transaction.ConfirmGramTransfer': 'Do you want to transfer this gift for **%s Grams**?',
  'Stars.Transaction.ConfirmGramPurchase': 'Do you want to buy this gift for **%s Grams**?',
  'Stars.Transaction.MiniApp': 'Mini app',
  'Stars.Transaction.Referred': 'Referred user',
  'Stars.Transaction.AffiliateProgram': 'Affiliate program',
  'Stars.Transaction.Retry': 'Retry',
  'Stars.Transaction.Empty': 'No transactions yet',
  'Stars.Transaction.AppStore': 'App Store',
  'Stars.Transaction.PlayMarket': 'Google Play',
  'Stars.Transaction.Fragment': 'Fragment',
  'Stars.Transaction.Ads': '7eve9Chat Ads',
  'Stars.Transaction.API': '7eve9Chat API',
  'Stars.Transaction.Unsupported': 'Unknown transaction',
  'Stars.Transaction.GiftDescription': 'Gift description removed',
  'Stars.Transaction.Search': 'Post search fee',
  'Stars.Transaction.Premium': '7eve9Chat Premium · %d months',
  'Stars.Transaction.LiveReaction': 'Live stream reaction',
  'Stars.Transaction.LiveMessages': 'Live stream messages · %d',
  'Stars.Transaction.Broadcast': 'Paid broadcast · %d messages',
  'Stars.Transaction.Commission': 'Affiliate commission · %s%',
  'Stars.Transaction.Auction': 'Gift auction bid',
  'Stars.Transaction.PrepaidUpgrade': 'Prepaid gift upgrade',
  'Stars.Transaction.Upgrade': 'Gift upgrade',
  ...
  'Stars.Transaction.GiftConverted': 'Gift converted to Stars',
  'Stars.Transaction.BusinessTransfer': 'Business bot transfer',
  'Stars.Transaction.AdsProceeds': 'Advertising revenue',
  'Stars.Transaction.Subscription': 'Subscription fee',
  'Stars.Transaction.Withdrawal': 'Withdrawal via Fragment',
  'Stars.Transaction.GramTopup': 'Gram top-up',
  'Stars.Transaction.Payment': 'Payment',
  'Stars.Transaction.Period': 'Billing period',
  'Stars.Transaction.PeriodSeconds': '%d seconds',
  'Stars.Transaction.Referrer': 'Referrer',
  'Stars.Transaction.CommissionLabel': 'Commission',
  'Stars.Transaction.CommissionAmount': 'Commission amount',
  'Stars.Transaction.Completed': 'Completed',
  'Stars.Transaction.Blockchain': 'Blockchain transaction',
  'Stars.Transaction.View': 'View transaction',
  'Stars.Transaction.RevenuePeriod': 'Revenue period',
  'Stars.Transaction.UnknownPeer': 'Unknown user',
  'Stars.Transaction.Duration': 'Duration',
  'Stars.Transaction.Months': '%d months',
  'Stars.Transaction.Messages': 'Messages',
  'Stars.Transaction.BoughtFrom': 'Bought from',
  'Stars.Transaction.SoldTo': 'Sold to',
  'Stars.Transaction.GramTOS': 'Review the **[Terms of Service](https://7eve9craft.ir)** for Grams.',
  'Stars.Transaction.History': 'Transaction history',
  ...
  'FactCheckToast': 'This clarification was provided by 7eve9Chat.',
  'FactCheckFooter': 'This clarification was provided by 7eve9Chat.',
  ...
  'AnimatedEffectPremium': 'Subscribe to **7eve9Chat Premium** to add this animated effect.',
  ...
  'ActionGiftStarsSubtitle': 'With Stars, **%s** is able to unlock content and services on 7eve9Chat.',
  'ActionGiftStarsSubtitleYou': 'Use Stars to unlock content and services on 7eve9Chat.',
  'GiftStarsTitle': 'Gift Stars',
  'GiftStarsSubtitle': 'With Stars, **%s** will be able to unlock content and services on 7eve9Chat.',
  ...
  'StarGiftUpgradeTransferableText': 'Send your upgraded gift to any of your friends on 7eve9Chat.',
  'StarGiftUpgradeTransferableTextPrepaid': '%s will be able to send the gift to anyone on 7eve9Chat.',
  ...
  'StarGiftValueAboutAverage': 'The average sale price of **%s** gifts on 7eve9Chat and Fragment over the past month.',
  'StarGiftValueAboutLastFragment': 'This is the price at which **%s** was last sold on Fragment',
  'StarGiftValueAboutLastTelegram': 'This is the price at which **%s** was last sold on 7eve9Chat',
  ...
  'StarGiftMinimumPriceTooltip': '**%s** is the floor price for **%s** gifts listed on 7eve9Chat and Fragment.',
  'StarGiftAveragePrice': 'Average Price',
  'StarGiftAveragePriceTooltip': '**%s** is the average sale price of **%s** gifts on 7eve9Chat and Fragment over the past month.',
  'StarGiftViewResaleTelegram': '%s for sale on 7eve9Chat %s',
  ...
  'Reported2': '7eve9Chat moderators will review your report. Thank you!',
  ...
  'InviteLink.QRCode.InfoGroupCall': 'Everyone on 7eve9Chat can scan this code to join your group call.',
  ...
  'Call.StatusGroupInvite': '7eve9Chat Group Call',
  'Contacts.PhoneNumber.NotRegistred': 'The person with this phone number is not registered on 7eve9Chat yet.',
  'Channel.UsernameAboutChannel': 'People can share this link with others and can find your channel using 7eve9Chat search.',
  'Channel.UsernameAboutGroup': 'People can share this link with others and find your group using 7eve9Chat search.',
  ...
  'Chat.Service.PeerJoinedTelegram': '%@ joined 7eve9Chat',
  ...
  'ConferenceCall.Create.Action': 'Start New Call',
  'ConferenceCall.Create.Description': {
    'one_value': 'You can add up to %1$d participant to a call.',
    'other_value': 'You can add up to %1$d participants to a call.'
  },
  'ConferenceCall.NewCall.Title': 'New Call',
  'ConferenceCall.NewCall.Create': 'Create',
  'ConferenceCall.NewCall.Add': 'Add',
  'ConferenceCall.NewCall.CallBack': 'Call',
  'ConferenceCall.NewCall.VideoCallBack': 'Video call',
  'CallLink.Title': 'Call Link',
  'CallLink.About': 'Anyone on 7eve9Chat can join your call by following the link below.',
  'CallLink.Join': 'Be the first to join the call and add people from there. %1$@',
  'CallLink.JoinLink': 'Open call >',
  'CallLink.RevokeAlert': 'Are you sure you want to revoke this link? A new link will be generated and no one will be able to join using the old one.',
  'CallLink.Revoked': 'Link revoked. A new link has been generated.',
  'ConferenceCall.Join.Title': 'Group Call',
  'ConferenceCall.Join.Text': 'You are invited to join a 7eve9Chat Call.',
  'ConferenceCall.Join.TextInviter': '**%1$@** is inviting you to join a 7eve9Chat Call.',
  ...
  'ConferenceCall.Unsupported': 'Encrypted group calls are not supported in this browser. Open this call in a supported 7eve9Chat app.',
  ...
  'Chat.Message.Ad.Text': 'Unlike other apps, 7eve9Chat never uses your private data to target ads. Sponsored messages on 7eve9Chat are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on 7eve9Chat sees the same sponsored messages.\n\nUnlike other apps, 7eve9Chat doesn\'t track whether you tapped on a sponsored message and doesn\'t profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\n7eve9Chat offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, 7eve9Chat developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow 7eve9Chat to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.',
  ...
  'CustomEmoji.PremiumAlert': 'Subscribe to 7eve9Chat Premium to unlock this emoji. [Read More]()',
  'Date.Today': 'Today',
  ...
  'PrivacySettings.Voice.PremiumError': 'Only subscribers of [7eve9Chat Premium]() can restrict receiving Voice and Video Messages.',
  ...
  'PrivacySettingsController.P2p.Desc': 'Disabling peer-to-peer will relay all calls through 7eve9Chat servers to avoid revealing your IP address, but may slightly decrease audio and video quality.',
  ...
  'Action.SuggestedProfilePhoto': 'un1 suggests this photo for your 7eve9Chat profile',
  ...
  'GroupEmojiPack.LinkInfo': 'All members will be able to use these emoji in the group, even if they don\'t have 7eve9Chat Premium.',
  ...
  'Schedule.Repeat.PremiumRequired': 'Subscribe to **[7eve9Chat Premium]()** to schedule repeating messages.',
  ...
  'TwoStepAuth.GenericHelp': 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your 7eve9Chat account.',
  ...
  'Premium.Boarding.NoAds.Info': 'No more ads in public channels where 7eve9Chat sometimes shows ads.',
  ...
  'Premium.Boarding.Badge.Info': 'An exclusive badge next to your name showing that you subscribe to 7eve9Chat Premium.',
  ...
  'Premium.Boarding.Title': '7eve9Chat Premium',
  'Premium.Boarding.Info': 'Go **beyond the limits** and **unlock dozens of exclusive** features by subscribing to **7eve9Chat Premium**.',
  'Premium.Boarding.Got.Title': 'You are all set!',
  'Premium.Boarding.Got.Info': 'Thank you for subscribing to 7eve9Chat Premium. Here\'s what is now unlocked.',
  'Premium.Boarding.Peer.Title': '[%@](profile) is a subscriber of\n7eve9Chat Premium',
  'Premium.Boarding.Peer.Info': 'Owners of 7eve9Chat Premium accounts have exclusive access to multiple additional features.',
  ...
  'Premium.Boarding.About.Title': 'About 7eve9Chat Premium',
  'Premium.Boarding.About.Text': 'While the free version of 7eve9Chat already gives its users more than any other messaging application, **7eve9Chat Premium** pushes its capabilities even further.\n\n**7eve9Chat Premium** is a paid option, because most Premium Features require additional expenses from 7eve9Chat to third parties such as data center providers and server manufacturers. Contributions from **7eve9Chat Premium** users allow us to cover such costs and also help 7eve9Chat stay free for everyone.',
  'Premium.Boarding.About.Tos': 'By purchasing a Premium subscription, you agree to the 7eve9Chat [Terms of Service](terms) and [Privacy Policy](privacy).',
  'Premium.Boarding.AppStore.Cancelled': 'Purchase was canceled or failed.',
  'Premium.Boarding.AppStore.Success': 'You successfully subscribed for 7eve9Chat Premium.',
  ...
  'Premium.Offset.AlreadyHave': 'You already have 7eve9Chat Premium.',
  ...
  'Language.TranslateMessages.Channel.Premium': 'Subscribe to [7eve9Chat Premium](premium) to translate entire chats.',
  ...
  'Chat.DownloadLimit.Text': {
    'one_value': 'Subscribe to [7eve9Chat Premium]() to increase download speeds %d time.',
    'other_value': 'Subscribe to [7eve9Chat Premium]() to increase download speeds %d times.'
  },
  'Chat.UploadLimit.Text': {
    'one_value': 'Subscribe to [7eve9Chat Premium]() to increase upload speeds %d time.',
    'other_value': 'Subscribe to [7eve9Chat Premium]() to increase upload speeds %d times.'
  },
  'Chat.Service.Refund': '%@ refunded %@',
  'EnableDarkMode': 'Enable Dark Mode',
  'DisableDarkMode': 'Disable Dark Mode',
  'DisableAnimations': 'Disable Animations',
  'AudioAndVideoTranscription.PremiumAlert': 'Subscribe to 7eve9Chat Premium to unlock video and audio transcription. [Read More]()',
  ...
  'PasscodeLock.Description': 'When a passcode is set, a lock icon appears above your chat list. Tap it to lock your 7eve9Chat.',
  ...
  'PasscodeLock.TapToLock': 'Tap to lock 7eve9Chat.',
  ...
  'PeerInfo.AppFooter': 'By launching this mini app, you agree to the [Terms of Service for Mini Apps](https://7eve9craft.ir).',
  'PeerInfo.AppFooterAdmin': 'By publishing this mini app, you agree to the [7eve9Chat Terms of Service for Developers](https://7eve9craft.ir).',
  ...
  'BotStorySharingNotSupported': 'Sharing to Stories is not supported in the Web app. Please use one of 7eve9Chat\'s mobile apps.',
  ...
  'VerificationCodesBotDescription': 'Third-party services, like websites and stores, can send verification codes to your phone number via 7eve9Chat instead of SMS. Such codes will appear in this chat.\n\nIf you didn\'t request any codes – don\'t worry! Most likely, someone made a mistake when entering their number.',
  ...
  'StarsRating.Subtitle': 'This rating reflects **%s**’s activity on 7eve9Chat. What affects it:',
  'StarsRating.SubtitleMy': 'This rating reflects your activity on 7eve9Chat. What affects it:',
  'StarsRating.Row1Title': 'Gifts from 7eve9Chat',
  'StarsRating.Row1Subtitle': '100% of the Stars spent on gifts purchased from 7eve9Chat.',
  ...
  'EmailSetup.ChangeSubtitle': 'You will receive 7eve9Chat login codes via email and not SMS. Please enter an email address to which you have access.',
  ...
  'AiEditor.PremiumFlood': 'You have hit the limit for now. Subscribe to [7eve9Chat Premium]() to increase the limit by 50 times or try again later.',
  ...
  // Tip cards shown on the empty chat column (@components/chatTips)
  'ChatTips.Appearance': 'Appearance',
  'ChatTips.Appearance.Description': 'You can change these parameters and many others in Settings > [General Settings]().',
  'ChatTips.Appearance.System': 'System',
  'ChatTips.Appearance.Dark': 'Dark',
  'ChatTips.Appearance.Light': 'Light',
  'ChatTips.Chats': 'Chats',
  'ChatTips.Chats.Description': 'Use **Ctrl+F** to enter [search]() mode.',
  'ChatTips.Chats.DescriptionMac': 'Use **Cmd+F** to enter [search]() mode.',
  // One word each — the three buttons split the card's fixed width, so a longer label truncates.
  'ChatTips.Chats.Popular': 'Popular',
  'ChatTips.Chats.RecentSearch': 'Searched',
